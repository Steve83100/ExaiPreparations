...
class Net(nn.Module):
    def __init__(self):
        ...
        self.net = nn.Sequential(
            ...
            nn.LazyLinear(4096), nn.ReLU(),
            nn.LazyLinear(10) # No need to add final softmax. CrossEntropyLoss does it for us.
        )
...
if __name__ == '__main__':
    ...
    trainSet = torchvision.datasets.CIFAR10(root="D:/Coding/DeepLearning/Datasets", train=True, download=True, transform=transform)
    trainLoader = data.DataLoader(trainSet, batch_size=batch_size, shuffle=True, num_workers=2)
    testSet = torchvision.datasets.CIFAR10(root="D:/Coding/DeepLearning/Datasets", train=False, download=True, transform=transform)
    ...
    # Save model to disk
    PATH = 'D:/Coding/DeepLearning/ModelSaves/vgg_cifar10.pth'
